...
- `Fix bug in user auth flow`
- `Add loading spinner to dashboard`
- `Refactor API helper functions`
...
Tools like [Gatsby](https://www.gatsbyjs.com/), [Next.js](https://nextjs.org/), or even simple static site generators like [Jekyll](https://jekyllrb.com/) make this easier than ever.
...
- [Dev.to: Start Writing](https://dev.to/new)
- [Hashnode: Blogging for Developers](https://hashnode.com/)
- [Twitter for Developers](https://developer.twitter.com/en/docs)
- [LinkedIn Help: Building Your Profile](https://www.linkedin.com/help/linkedin/answer/112)
